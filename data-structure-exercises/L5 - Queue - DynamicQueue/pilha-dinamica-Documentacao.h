...
struct NoPilha
{
    Documentacao dado; //informação do nó
...
//push
bool empilhaP(Pilha *p, Documentacao dado)
{
...
//pop
Documentacao desempilhaP(Pilha *p)
{
    Documentacao dado;
...
/*bool buscaP(Pilha *p, Documentacao dado)
{
